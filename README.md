...
[![Build Status](https://travis-ci.com/nwosuudoka/go-gecko.svg?branch=master)](https://travis-ci.com/nwosuudoka/go-gecko) [![GoDoc](https://godoc.org/github.com/nwosuudoka/go-gecko?status.svg)](https://godoc.org/github.com/nwosuudoka/go-gecko)
...
```
go get -u github.com/nwosuudoka/go-gecko
```
...
import (
	...
	coingecko "github.com/nwosuudoka/go-gecko/v3"
)
